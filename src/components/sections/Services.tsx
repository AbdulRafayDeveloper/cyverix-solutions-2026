      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="text-center mb-16">
          ...
          <p className="text-text-secondary max-w-2xl mx-auto text-lg mb-6">
            We build websites, desktop and mobile apps, SaaS-style products, and AI-powered features (assistants, automation, and model integrations) for teams that need clear delivery, not buzzwords. Pick a lane below or read the full list on our services page.
          </p>
          <Link
            href="/services"
