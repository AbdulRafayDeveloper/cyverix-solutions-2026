...
export const Careers = () => {
  return (
    <section id="careers" className="py-32 px-6 min-h-screen snap-start snap-always w-full flex flex-col justify-center relative bg-background overflow-hidden">
      {/* Decorative lines */}
